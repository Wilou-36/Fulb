...
namespace FBank
{
    public partial class loginAdmin : Form
    {
        public loginAdmin()
        {
            ...
            // Forcer la police des TextBox à 12pt et masquer le mot de passe
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Connexion réussie — ouvrir PageAdmin en lui passant la référence au formulaire courant
                    var pageAdmin = new PageAdmin(this);
        ...
        private void SetTextBoxesFont(Control parent, float size)
        {
            foreach (Control c in parent.Controls)
            {
                if (c is TextBox tb)
                {
                    tb.Font = new System.Drawing.Font(tb.Font.FontFamily, size, tb.Font.Style);
                }
                else
                {
                    if (c.HasChildren)
